        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link href="#project" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Sponsor</Nav.Link>
            </Nav>
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd"><span>RSVP</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
